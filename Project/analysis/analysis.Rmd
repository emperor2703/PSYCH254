...
```{r Manipulation check, fig.width = 5, fig.height = 4}
...
Participants rated how quickly each target made his decision immediately after they read the vignette and at the end of the experiment. In both cases, quick Justin was rated as having made his decision more quickly than slow Nate (Fig. 1, at the start of the experiment: t(119) = 31.32, p < 0.001, at the end of the experiment t(119) = 30.93, p < 0.001)
...
<center><img src="PathModel_R.png"></img></center>  
